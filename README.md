...
- ⭐ Stars, sounds, and a celebration when she finishes.
- 🔊 Voice on/off toggle (the mascot speaks every line — great for pre-readers).
- 💾 Progress saved on the device.

Later levels (movement games, capturing, checkmate, special moves, playing the
AI) are shown as "coming soon" on the map and built in the next phases.
